...
ggplot(plot.df[plot.df$Reference == "Observed", ], aes(x = HR, xmin = LowBoundCI, xmax = HighBoundCI, y = Condition)) +
...
ggplot(plot.df[plot.df$Reference == "Observed", ], aes(x = HR, y = Condition)) +
                      geom_pointrange(pch = 15, size = 1) +
